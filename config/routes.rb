Rails.application.routes.draw do
  ...
  # =============================================================================
  # MOCKUPS NAMESPACE - ALL MOCKUP ROUTES
  # =============================================================================

  namespace :mockups do
    # Base mockup pages (index, typography, user/admin journeys)
    get '/', to: 'base#index', as: :root
    get 'index', to: 'base#index'
    get 'user_dashboard', to: 'base#user_dashboard'
    get 'user_profile', to: 'base#user_profile'
    get 'user_settings', to: 'base#user_settings'
    get 'admin_dashboard', to: 'base#admin_dashboard'
    get 'admin_users', to: 'base#admin_users'
    get 'admin_analytics', to: 'base#admin_analytics'
    get 'typography', to: 'base#typography'
    ...
    # -------------------------------------------------------------------------
    # ROUTES INDEX (shows all routes organized by role)
    # -------------------------------------------------------------------------
  ...
  # =============================================================================
  # API ENDPOINTS (for AJAX/SPA features - kept outside mockups)
  # =============================================================================
