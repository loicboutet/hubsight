...
**Total Tasks: 91 | Budget: €10,000 (€5,000 per Brick)**
...
**All development must strictly adhere to:**
1. **Approved Design Mockups** - Only implement features visible in approved UI designs
2. **en_specifications.md** - Follow the functional specifications exactly as documented
3. **data_models_referential.md** - Respect the defined data models and relationships

**Note:** If a backlog item conflicts with these sources, the specification and approved designs take precedence. Consult before implementing conflicting features.
...
## 👑 PORTFOLIO MANAGER - USER MANAGEMENT (SL 10-11) - BRICK 1

### SL 10: PM - Create Site Manager Profiles
**Brick:** 1  
...
### SL 11: PM - Assign Sites to Site Managers
**Brick:** 1  
...
## 🏗️ PORTFOLIO MANAGER - ASSET STRUCTURE (SL 12-17) - BRICK 1

### SL 12: PM - Create and Manage Sites
**Brick:** 1  
...
### SL 13: PM - Create and Manage Buildings
**Brick:** 1  
...
### SL 14: PM - Create and Manage Levels
**Brick:** 1  
...
### SL 15: PM - Create and Manage Spaces
**Brick:** 1  
...
### SL 16: PM - Create and Manage Equipment
**Brick:** 1  
...
## 🔧 PORTFOLIO MANAGER - EQUIPMENT DATABASE (SL 18-22) - BRICK 1

### SL 18: PM - Import OmniClass Table 23
**Brick:** 1  
...
### SL 19: PM - Import Space Structure
**Brick:** 1  
...
### SL 20: PM - Import Contract Families
**Brick:** 1  
...
### SL 21: PM - Equipment Search & Autocomplete
**Brick:** 1  
...
### SL 22: PM - Link Equipment to OmniClass
**Brick:** 1  
...
## 📄 PORTFOLIO MANAGER - CONTRACT MANAGEMENT (SL 23-33) - BRICK 1

### SL 23: PM - Upload PDF Contracts
**Brick:** 1  
...
### SL 24: PM - OCR Text Extraction (Mistral)
**Brick:** 1  
...
### SL 25: PM - LLM Data Structuring (OpenRouter)
**Brick:** 1  
...
### SL 26: PM - Validate Extracted Data
**Brick:** 1  
...
### SL 27: PM - Manual Contract Creation
**Brick:** 1  
...
### SL 28: PM - Contract Family Search
**Brick:** 1  
...
### SL 29: PM - Link Services to Contract Families
**Brick:** 1  
...
### SL 30: PM - Auto-Calculate Contract Dates
**Brick:** 1  
...
### SL 31: PM - Auto-Calculate VAT Amounts
**Brick:** 1  
...
## 🏢 PORTFOLIO MANAGER - ORGANIZATION MANAGEMENT (SL 34-38) - BRICK 1

### SL 34: PM - Create Organizations
**Brick:** 1  
...
### SL 37: PM - Organization Search & Autocomplete
**Brick:** 1  
...
### SL 38: PM - Link Organizations to Contracts
**Brick:** 1  
...
## 📊 PORTFOLIO MANAGER - EXPORTS & REPORTS (SL 39-42) - BRICK 1

### SL 39: PM - Generate Contract PDF Summary
**Brick:** 1  
...
## 📈 PORTFOLIO MANAGER - DASHBOARD & VISUALIZATION (SL 43-45) - BRICK 1

### SL 43: PM - Portfolio Overview Dashboard
**Brick:** 1  
...
### SL 44: PM - Key Indicators Display
**Brick:** 1  
...
### SL 50: SM - Generate Contract PDF
**Brick:** 1  
...
## ⚙️ SYSTEM FEATURES - BRICK 1 (SL 51-55)

### SL 51: System - Data Isolation
**Brick:** 1  
...
### SL 52: System - Responsive Web Design
**Brick:** 1  
...
## 📋 ADMIN FEATURES - BRICK 2 (SL 56-59)

### SL 56: Admin - Price Reference Management
**Brick:** 2  
...
### SL 57: Admin - Create Price References
**Brick:** 2  
...
### SL 58: Admin - Import Price References
**Brick:** 2  
...
### SL 59: Admin - Export Price References
**Brick:** 2  
...
## 🤖 PM - AUTOMATIC MATCHING - BRICK 2 (SL 60-64)

### SL 60: PM - Auto-Match Equipment to Database
**Brick:** 2  
...
### SL 61: PM - Auto-Match Contract Families
**Brick:** 2  
...
### SL 62: PM - Auto-Match Organizations
**Brick:** 2  
...
### SL 63: PM - Validate/Correct Suggestions
**Brick:** 2  
...
### SL 64: PM - Progressive Learning System
**Brick:** 2  
...
## 🔔 PM - ALERT SYSTEM - BRICK 2 (SL 65-71)

### SL 65: PM - Upcoming Alerts
**Brick:** 2  
...
### SL 67: PM - Missing Contracts Alerts
**Brick:** 2  
...
### SL 70: PM - Configure Notifications
**Brick:** 2  
...
## 💰 PM - PRICE COMPARISON & SAVINGS - BRICK 2 (SL 72-78)

### SL 72: PM - Automatic Price Comparison
**Brick:** 2  
...
### SL 73: PM - Calculate Potential Savings
**Brick:** 2  
...
### SL 74: PM - View Savings by Contract
**Brick:** 2  
...
### SL 77: PM - Economic Analysis Report
**Brick:** 2  
...
### SL 78: PM - Auto-Update on Reference Change
**Brick:** 2  
...
## 📊 PM - ENHANCED DASHBOARD - BRICK 2 (SL 79-82)

### SL 79: PM - Total Savings Dashboard Widget
**Brick:** 2  
...
### SL 81: PM - Expiring Contracts Widget
**Brick:** 2  
...
### SL 82: PM - At-Risk Contracts Widget
**Brick:** 2  
...
### SL 85: SM - View Site Alerts Dashboard
**Brick:** 2  
...
## ⚙️ SYSTEM FEATURES - BRICK 2 (SL 86-91)

### SL 86: System - Background Job Processing
**Brick:** 2  
...
### SL 88: System - Email Service Integration
**Brick:** 2  
...
### SL 91: System - API Rate Limiting
**Brick:** 2  
...
**Admin (8-9, 56-59):** User management, client data access, price references  
**Portfolio Manager User Management (10-11):** Create site managers, assign sites  
**Asset Structure (12-17):** Sites, buildings, levels, spaces, equipment, tree navigation  
**Equipment DB (18-22):** Imports, search, OmniClass linking  
**Contracts (23-33):** Upload, OCR, LLM extraction, validation, manual entry, lists, filters  
**Organizations (34-38):** Companies, contacts, agencies, search, linking  
**Exports (39-42):** PDF summaries, Excel exports  
**Dashboards (43-45, 79-82):** Portfolio overview, analytics, widgets  
**Site Manager (46-50, 83-85):** View sites, contracts, equipment, savings, alerts  
**Auto-Matching (60-64):** Equipment, families, organizations, validation, learning  
**Alerts (65-71):** Upcoming, at-risk, missing, acknowledge, notifications, dashboard  
**Savings (72-78):** Price comparison, calculations, views, reports, auto-update  
**System (51-55, 86-91):** Isolation, responsive, branding, security, search, jobs, audit
