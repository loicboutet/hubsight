...
class Mockups::Admin::PortfolioManagersController < ApplicationController
  layout 'mockup_admin'
  
  # GET /mockups/admin/portfolio_managers
  def index
  end
  
  # GET /mockups/admin/portfolio_managers/:id
  def show
  end
  
  # GET /mockups/admin/portfolio_managers/new
  def new
    @portfolio_manager = OpenStruct.new
    @portfolio_manager.define_singleton_method(:persisted?) { false }
  end
  
  # POST /mockups/admin/portfolio_managers
  def create
  end
  
  # GET /mockups/admin/portfolio_managers/:id/edit
  def edit
  ...
  # PATCH/PUT /mockups/admin/portfolio_managers/:id
  def update
  end
  
  # DELETE /mockups/admin/portfolio_managers/:id
  def destroy
  end
end
