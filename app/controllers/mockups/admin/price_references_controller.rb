...
class Mockups::Admin::PriceReferencesController < ApplicationController
  layout 'mockup_admin'
  
  # GET /mockups/admin/price_references
  def index
  end
  
  # GET /mockups/admin/price_references/:id
  def show
  end
  
  # GET /mockups/admin/price_references/new
  def new
    @price_reference = OpenStruct.new
    @price_reference.define_singleton_method(:persisted?) { false }
  end
  
  # POST /mockups/admin/price_references
  def create
  end
  
  # GET /mockups/admin/price_references/:id/edit
  def edit
    @price_reference = OpenStruct.new(
  ...
  # PATCH/PUT /mockups/admin/price_references/:id
  def update
  end
  
  # DELETE /mockups/admin/price_references/:id
  def destroy
  end
  
  # GET /mockups/admin/price_references/import
  def import
  end
  
  # POST /mockups/admin/price_references/import
  def process_import
  end
  
  # GET /mockups/admin/price_references/export
  def export
  end
end
